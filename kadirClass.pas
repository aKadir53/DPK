...
constructor TLabIslemleri.Create;
var
  reg : TREGISTRy;
begin
    inherited Create;
...
function TLabIslemleri.SonucDoldur(s : string) : ArraySonucBilgisi;
var
  Str , _c_ : String;
...
function TLabIslemleri.SonucGoster : Tdataset;
var
  sql : string;
  i : integer;
begin
...
function TLabIslemleri.SonucGosterKabulden : Tdataset;
var
  sql : string;
  i : integer;
begin
...
procedure TLabIslemleri.Kaydet;
begin
  //ShowMessage('xxx');
